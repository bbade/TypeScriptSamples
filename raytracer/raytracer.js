...
var RayTracer = /** @class */ (function () {
    ...
    RayTracer.prototype.render = function (scene, ctx, screenWidth, screenHeight) {
        var outputImageData = ctx.createImageData(ctx.getImageData(0, 0, screenWidth, screenHeight));
        var pixels = outputImageData.data;
...
function drawOnArray(arr, imgWidth, c, x, y) {
    var i = y * imgWidth * 4 + x * 4;
...
function drawOnCanvas(ctx, c, x, y) {
